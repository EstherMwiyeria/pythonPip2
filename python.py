...
print(even_numbers([3,5,45,97,32,22,10,19,39,43]))
...
# 9. Use a nested list comprehension to find all of the numbers from 1-1000 that are divisible by any single digit besides 1 (2-9)
